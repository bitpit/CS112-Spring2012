...
screen.fill(BLACK)
quit_rect = pygame.Rect((30,313), (90,31))  #rects for checking collision w/ 
start_rect =  pygame.Rect((30,213), (249,32)) #menu items
start_medium_rect = pygame.Rect((30,260), (289,32))
won = False
init = True
game_OVER = False
...
while not done:
    ...
    for evt in pygame.event.get():
        ...
        if start_rect.collidepoint(pygame.mouse.get_pos()):
            ...
            hover = quit_rect
        elif start_medium_rect.collidepoint(pygame.mouse.get_pos()):
            hover = start_medium_rect
        else:
            hover = False
    ...
    if hover == start_rect:
        ...
        COLOR2 = COLOR4
    elif hover == start_medium_rect:
        COLOR3 = COLOR4
    render_font("Start Easy Game",48,215,COLOR1,40)
    render_font("o",34,224,COLOR1,17)
    render_font("Start Medium Game",48,263,COLOR3,40)
    render_font("o",34,272,COLOR3,17)
    render_font("Quit",48,315,COLOR2,40)
    render_font("o",34,324,COLOR2,17)
    ...
    while game == True:
        ...
        #intializes gameboard if first time through the loop
        if (init == True):
            pygame.display.quit()
            pygame.display.init()
        ...
        for evt in pygame.event.get():
            ...
            #input for unovering/flagging
                ...
                if exit_rect.collidepoint(pygame.mouse.get_pos()):
                    ...
                    pygame.display.quit()
                    pygame.display.init()
                    screen = pygame.display.set_mode((340,520))
                    break
                for x in range(10):
                    for y in range(10):
                        rect = tile_rects[x][y]
